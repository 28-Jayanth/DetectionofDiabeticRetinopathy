...
# Train the model
r = model.fit(train_set, validation_data=test_set, epochs=25, steps_per_epoch=len(train_set), validation_steps=len(test_set))
...
sns.heatmap(cm, annot=True, fmt="d", cmap="Blues", xticklabels=train_set.class_indices.keys(), yticklabels=train_set.class_indices.keys())
